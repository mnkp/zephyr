...
#define PIN_TC0_TCLK0 {PIO_PA4B_TC0_TCLK0,  PIOA, ID_PIOA, SOC_GPIO_FUNC_B}
#define PIN_TC0_TCLK1 {PIO_PA28B_TC0_TCLK1, PIOA, ID_PIOA, SOC_GPIO_FUNC_B}
#define PIN_TC0_TCLK2 {PIO_PA29B_TC0_TCLK2, PIOA, ID_PIOA, SOC_GPIO_FUNC_B}
#define PIN_TC0_TIOA0 {PIO_PA0B_TC0_TIOA0,  PIOA, ID_PIOA, SOC_GPIO_FUNC_B}
#define PIN_TC0_TIOA1 {PIO_PA15B_TC0_TIOA1, PIOA, ID_PIOA, SOC_GPIO_FUNC_B}
#define PIN_TC0_TIOA2 {PIO_PA26B_TC0_TIOA2, PIOA, ID_PIOA, SOC_GPIO_FUNC_B}
#define PIN_TC0_TIOB0 {PIO_PA1B_TC0_TIOB0,  PIOA, ID_PIOA, SOC_GPIO_FUNC_B}
#define PIN_TC0_TIOB1 {PIO_PA16B_TC0_TIOB1, PIOA, ID_PIOA, SOC_GPIO_FUNC_B}
#define PIN_TC0_TIOB2 {PIO_PA27B_TC0_TIOB2, PIOA, ID_PIOA, SOC_GPIO_FUNC_B}

#define PINS_TCO {PIN_TC0_TCLK0, PIN_TC0_TCLK1, PIN_TC0_TCLK2, \
	  PIN_TC0_TIOA0, PIN_TC0_TIOA1, PIN_TC0_TIOA2, PIN_TC0_TIOB0, \
	  PIN_TC0_TIOB1, PIN_TC0_TIOB2}

#define PIN_TC1_TCLK0 {PIO_PC25B_TC1_TCLK3, PIOC, ID_PIOC, SOC_GPIO_FUNC_B}
#define PIN_TC1_TCLK1 {PIO_PC28B_TC1_TCLK4, PIOC, ID_PIOC, SOC_GPIO_FUNC_B}
#define PIN_TC1_TCLK2 {PIO_PC31B_TC1_TCLK5, PIOC, ID_PIOC, SOC_GPIO_FUNC_B}
#define PIN_TC1_TIOA0 {PIO_PC23B_TC1_TIOA3, PIOC, ID_PIOC, SOC_GPIO_FUNC_B}
#define PIN_TC1_TIOA1 {PIO_PC26B_TC1_TIOA4, PIOC, ID_PIOC, SOC_GPIO_FUNC_B}
#define PIN_TC1_TIOA2 {PIO_PC29B_TC1_TIOA5, PIOC, ID_PIOC, SOC_GPIO_FUNC_B}
#define PIN_TC1_TIOB0 {PIO_PC24B_TC1_TIOB3, PIOC, ID_PIOC, SOC_GPIO_FUNC_B}
#define PIN_TC1_TIOB1 {PIO_PC27B_TC1_TIOB4, PIOC, ID_PIOC, SOC_GPIO_FUNC_B}
#define PIN_TC1_TIOB2 {PIO_PC30B_TC1_TIOB5, PIOC, ID_PIOC, SOC_GPIO_FUNC_B}

#define PINS_TC1 {PIN_TC1_TCLK0, PIN_TC1_TCLK1, PIN_TC1_TCLK2, \
	  PIN_TC1_TIOA0, PIN_TC1_TIOA1, PIN_TC1_TIOA2, PIN_TC1_TIOB0, \
	  PIN_TC1_TIOB1, PIN_TC1_TIOB2}

#define PIN_TC2_TCLK0 {PIO_PC7B_TC2_TCLK6,  PIOC, ID_PIOC, SOC_GPIO_FUNC_B}
#define PIN_TC2_TCLK1 {PIO_PC10B_TC2_TCLK7, PIOC, ID_PIOC, SOC_GPIO_FUNC_B}
#define PIN_TC2_TCLK2 {PIO_PC14B_TC2_TCLK8, PIOC, ID_PIOC, SOC_GPIO_FUNC_B}
#define PIN_TC2_TIOA0 {PIO_PC5B_TC2_TIOA6,  PIOC, ID_PIOC, SOC_GPIO_FUNC_B}
#define PIN_TC2_TIOA1 {PIO_PC8B_TC2_TIOA7,  PIOC, ID_PIOC, SOC_GPIO_FUNC_B}
#define PIN_TC2_TIOA2 {PIO_PC11B_TC2_TIOA8, PIOC, ID_PIOC, SOC_GPIO_FUNC_B}
#define PIN_TC2_TIOB0 {PIO_PC6B_TC2_TIOB6,  PIOC, ID_PIOC, SOC_GPIO_FUNC_B}
#define PIN_TC2_TIOB1 {PIO_PC9B_TC2_TIOB7,  PIOC, ID_PIOC, SOC_GPIO_FUNC_B}
#define PIN_TC2_TIOB2 {PIO_PC12B_TC2_TIOB8, PIOC, ID_PIOC, SOC_GPIO_FUNC_B}

#define PINS_TC2 {PIN_TC2_TCLK0, PIN_TC2_TCLK1, PIN_TC2_TCLK2, \
	  PIN_TC2_TIOA0, PIN_TC2_TIOA1, PIN_TC2_TIOA2, PIN_TC2_TIOB0, \
	  PIN_TC2_TIOB1, PIN_TC2_TIOB2}

#define PIN_TC3_TCLK0 {PIO_PE2B_TC3_TCLK9,   PIOE, ID_PIOE, SOC_GPIO_FUNC_B}
#define PIN_TC3_TCLK1 {PIO_PE5B_TC3_TCLK10,  PIOE, ID_PIOE, SOC_GPIO_FUNC_B}
#define PIN_TC3_TCLK2 {PIO_PD24C_TC3_TCLK11, PIOD, ID_PIOD, SOC_GPIO_FUNC_C}
#define PIN_TC3_TIOA0 {PIO_PE0B_TC3_TIOA9,   PIOE, ID_PIOE, SOC_GPIO_FUNC_B}
#define PIN_TC3_TIOA1 {PIO_PE3B_TC3_TIOA10,  PIOE, ID_PIOE, SOC_GPIO_FUNC_B}
#define PIN_TC3_TIOA2 {PIO_PD21C_TC3_TIOA11, PIOD, ID_PIOD, SOC_GPIO_FUNC_C}
#define PIN_TC3_TIOB0 {PIO_PE1B_TC3_TIOB9,   PIOE, ID_PIOE, SOC_GPIO_FUNC_B}
#define PIN_TC3_TIOB1 {PIO_PE4B_TC3_TIOB10,  PIOE, ID_PIOE, SOC_GPIO_FUNC_B}
#define PIN_TC3_TIOB2 {PIO_PD22C_TC3_TIOB11, PIOD, ID_PIOD, SOC_GPIO_FUNC_C}

#define PINS_TC3 {PIN_TC3_TCLK0, PIN_TC3_TCLK1, PIN_TC3_TCLK2, \
	  PIN_TC3_TIOA0, PIN_TC3_TIOA1, PIN_TC3_TIOA2, PIN_TC3_TIOB0, \
	  PIN_TC3_TIOB1, PIN_TC3_TIOB2}
